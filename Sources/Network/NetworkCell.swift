...
class NetworkCell: UITableViewCell {
    ...
    private func setupViews() {
        ...
        curlButton.titleLabel?.font = .systemFont(ofSize: 12, weight: .semibold)
    ...
    private func configure() {
        ...
        // Host tag (in top row)
        configureHostTag(model: model, serverURL: serverURL)
    ...
    private func configureContentTypeTag(model: _HttpModel) {
    ...
    private func configureHostTag(model: _HttpModel, serverURL: String) {
